...
export function CardButtonAnchor(props: CardButtonAnchorProps) {
  return (
    <a
      ...
      className="focus:shadow-outline group inline-flex h-10 w-full items-center justify-center rounded-full bg-green-600 px-6 font-medium tracking-wide text-white shadow-md hover:bg-brandWts hover:transition-all focus:outline-none sm:h-10 md:w-auto"
      {...props}
    />
  )
}
...
export function CardButtonText(props: CardButtonTextProps) {
  return (
    <div
      className="mr-3 font-semibold text-white group-hover:text-zinc-800 "
      {...props}
    />
  )
}
